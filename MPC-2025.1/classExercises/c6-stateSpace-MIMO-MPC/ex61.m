% =========================================================================
% Title       : Code 6.1 – Unrestricted State-Space Simulation of Camacho's
...
%
% The simulation is implemented in MATLAB using a **state-space representation**
% of the system. The control strategy is **unrestricted**, meaning no constraints
% are imposed on inputs or outputs.
%
% Key Features:
%   - Multi-Input Multi-Output (MIMO) system
%   - State-space modeling approach
%   - Unconstrained predictive control (no input/output limits)
%
% Purpose:
%   - Explore the application of MPC to MIMO systems
%
% Requirements:
%   - MATLAB
% -------------------------------------------------------------------------
